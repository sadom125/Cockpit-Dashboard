// constants.js — 全局常量（构建时直接拼接，不使用 module.exports）

var VIEW_TYPE = 'cockpit-dashboard';
var PLUGIN_ID = 'cockpit-dashboard';
var TODO_FILE = '_data/todos.md';
var BOOKMARK_FILE = '_data/bookmarks.md';

var E = { wave:'👋', search:'🔍', tag:'🏷️', graph:'🕸️', bolt:'⚡', folder:'📂', rule:'📋', gear:'⚙️', robot:'🤖', box:'📦', chart:'📊', pencil:'✏️', check:'✅', save:'💾', edit:'✏️', del:'✕', cal:'📅' };
var T = { cats:'📂 知识分类', todos:'✅ 待办事项', stats:'📊 统计进度', recent:'✏️ 最近更新' };
var COLORS = ['#818cf8','#f59e0b','#3b82f6','#22c55e','#ec4899','#14b8a6','#f97316','#6366f1'];
var ICONS  = ['📁','📂','🗂️','📋','📌','🏷️','🔖','📊'];
